...
import com.example.tarunkukreja.weather.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cursorLoc = mContext.getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI,
