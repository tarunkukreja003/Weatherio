package com.example.tarunkukreja.weather.services;
...
/**
 * Created by tarunkukreja on 20/02/17.
 */
...
//            }
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cursorLoc = this.getContentResolver().query(WeatherContract.LocationEntry.CONTENT_URI,
    ...
    static public class AlarmReciever extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
          // after 5 sec this is called and starts the service
            // we need to use Broadcast Reciever because we are recieving a broadcast
